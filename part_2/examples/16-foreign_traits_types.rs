...
// a local trait on a foreign type, but *not* a foreign trait on a foreign type, as this may lead to 
...
// impl std::string::ToString for f64 {/* ... */} // Compile error! 

// There is a way to get around this, using a 'wrapper' type and the Deref and DerefMut traits. 
// They will be discussed briefly in the common traits example.
