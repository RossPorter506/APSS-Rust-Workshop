fn main() {
    ...
    // We won't worry about the details for now, but macros are invoked almost exactly like a function, but with a ! after the name.
    println!("Hello!");

    // Rust supports format strings by adding curly brackets (called the 'placeholder'), then specifying the value to go within after the string:
